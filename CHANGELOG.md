...
- Расширенные параметры веб-поиска доступны из «Настройки → Подключение → OpenRouter → Инструменты и веб-поиск»; устаревший Firecrawl больше не предлагается как движок поиска.
