...
- Расширенные параметры веб-поиска доступны из «Настройки → Подключение → OpenRouter → Инструменты и веб-поиск». Список движков приведён к актуальному OpenRouter, включая Firecrawl (для него нужен настроенный BYOK).
