...
anchor = 'import androidx.compose.ui.text.font.FontFamily\nimport androidx.compose.ui.text.font.FontWeight\n'
replacement = '''import androidx.compose.ui.text.SpanStyle
...
old = '''                MessagePartKind.PLAIN -> if (part.text.isNotBlank()) {
                    SelectionContainer { Text(part.text.trim(), color = color) }
                }'''
new = '''                MessagePartKind.PLAIN -> if (part.text.isNotBlank()) {
                    MarkdownText(part.text.trim(), color)
                }'''
if old not in s:
    raise SystemExit('plain markdown anchor not found')
...
'''
if marker not in s:
    raise SystemExit('isolated block marker not found')
