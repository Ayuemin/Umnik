...
class ServerJobRecoveryWorker(context: Context, params: WorkerParameters) : CoroutineWorker(context, params) {
    override suspend fun doWork(): Result {
        ...
        // While the foreground runtime exists it owns the chat and delivery.
        ...
        return runCatching {
            ...
            // This POST is idempotent. If the original reached the VPS before Android died,
            // the server returns that same job; if it never arrived, this safely creates it once.
