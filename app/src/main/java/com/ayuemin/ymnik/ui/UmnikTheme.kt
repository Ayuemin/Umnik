...
private fun baseLight(
    ...
    primary = primary,
    onPrimary = lerp(primary, Color.White, 0.96f),
    primaryContainer = primaryContainer,
    onPrimaryContainer = onPrimaryContainer,
    secondary = secondary,
    onSecondary = lerp(secondary, Color.White, 0.96f),
    ...
    outline = lerp(primary, Color.Black, 0.56f),
    outlineVariant = lerp(primary, Color.White, 0.72f),
    surfaceContainerLowest = lerp(primary, Color.White, 0.992f),
...
private fun baseDark(
    ...
    primary = primary,
    onPrimary = lerp(primary, Color.Black, 0.90f),
    primaryContainer = primaryContainer,
    onPrimaryContainer = onPrimaryContainer,
    secondary = secondary,
    onSecondary = lerp(secondary, Color.Black, 0.90f),
    ...
    outline = lerp(primary, Color.White, 0.48f),
    outlineVariant = lerp(primary, Color.Black, 0.50f),
    surfaceContainerLowest = lerp(primary, Color.Black, 0.93f),
