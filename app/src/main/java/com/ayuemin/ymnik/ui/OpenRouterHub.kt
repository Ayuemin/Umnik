                        ...
                        Row(
                            ...
                            when (page) {
                                ...
                                HubPage.SHELL -> UmnikInfoHint(
                                    ...
                                    text = "Shell даёт модели рабочую среду для выполнения кода и обработки файлов. Особенно удобно передавать целые проекты и деревья папок в ZIP-архиве: Shell может распаковать архив, сохранить структуру каталогов, изучить код и данные и выполнить задачу над содержимым. Например: проверить проект приложения, очистить набор CSV, посчитать данные, преобразовать файлы или собрать отчёт. Для архивов рекомендуем ZIP. RAR и 7z могут зависеть от доступных утилит окружения и не считаются гарантированными. Добавьте файл или архив, опишите нужный результат и запустите задачу. Ответ и готовые файлы появятся в текущем чате."
                                )
                                else -> Unit
                            }
